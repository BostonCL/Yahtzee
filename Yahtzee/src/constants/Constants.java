...
public class Constants
{
    ...
    // constant for max rolls per turn
    ...
    public final static int FULL = 9;
    public final static int SMALL_STR = 10;
    public final static int LARGE_STR = 11;
    public final static int YATZEE_CAT = 12;
    ...
    // bonus threshold
    public final static int BONUS_SCORE = 63;
}
