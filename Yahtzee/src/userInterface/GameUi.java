...
public class GameUi extends JPanel
{
    ...
    private void initComponents()
    {
        ...
        logo = new JLabel();
        logo.setMinimumSize(new Dimension(30, 50));
        ...
        gameTurn.setMinimumSize(new Dimension(30, 50));
        gameTurn.setPreferredSize(new Dimension(30, 50));
        gameTurn.setMaximumSize(new Dimension(30, 50));
        gameTurn.setFont(new Font("Serif", Font.BOLD, 16));

        maxTurn = new JLabel();
        maxTurn.setMinimumSize(new Dimension(30, 50));
        maxTurn.setPreferredSize(new Dimension(30, 50));
        maxTurn.setMaximumSize(new Dimension(30, 50));
    ...
    private ImageIcon imageResize(ImageIcon icon)
    {
        ...
        Image newImage =
                image.getScaledInstance(150, 150, java.awt.Image.SCALE_SMOOTH);
